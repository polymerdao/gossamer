...
func (m *MocknodeBuilderIface) createRPCService(cfg *Config, ns *runtime.NodeStorage, stateSrvc *state.Service, coreSrvc *core.Service, networkSrvc *network.Service, bp modules.BlockProducerAPI, sysSrvc *system.Service, finSrvc *grandpa.Service) (*rpc.HTTPServer, error) {
	m.ctrl.T.Helper()
...
func (mr *MocknodeBuilderIfaceMockRecorder) createRPCService(cfg, ns, stateSrvc, coreSrvc, networkSrvc, bp, sysSrvc, finSrvc interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "createRPCService", reflect.TypeOf((*MocknodeBuilderIface)(nil).createRPCService), cfg, ns, stateSrvc, coreSrvc, networkSrvc, bp, sysSrvc, finSrvc)
}
